...
public class TryCatchExample {
	...
	// 강제로 예외 발생 - throw 키워드는... 예외 발생시키겠다는 뜻. throws가 아님
	public static void doSomething(int a) throws Exception {
		if ( a > 50) {
			throw new Exception("a가 50보다 큽니다."); // throw new는 예외객체
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("예외발생 원인 : " + e.getMessage()); // getMassage() 예외 발생 메시지 출력
		}finally { // 예외 처리시 항상 실행한 부분을 처리를 당담. 무조건 실행함
