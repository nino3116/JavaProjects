...
public class GenericExample3 {
	...
	//	리턴 타입과 매개변수 타입에서 사용하게 됨 t가 정해지면 나머지 T들이 정해지는 것
	
	// 제너릭 메서드  < T (extense Object)> T에 ()가 생략된거임
	...
	public static void main(String[] args) {
		...
		// 제너릭 메서드 호출
		Box2<String> box2 = boxing("점심 뭐 먹지?");
...
//		System.out.println(p1.equals(p2));
		...
		Pair<String, String> p3 = new Pair<>("user1", "이순신");
		Pair<String, String> p4 = new Pair<>("user2", "이순신");
