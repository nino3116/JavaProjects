...
public class ListExample1 {
	...
	//
	// 변경사항이 많이 일어나는 경우에는 Linked를 사용하면 좋아요. 단점은 리스트보단 검색이 느리다는 것
...
//		System.out.println(list);
		...
		// add(index, element) : 인덱스 위치에 요소값을 추가...
		...
		// indecOf : 데이터를 전달하면 해당데이터의 인덱스를 반환. 못찾는 경우(-1)
		System.out.println(list.indexOf("홍길동"));
		System.out.println(list.indexOf("홍길동00"));
		
		// remove(index) :	index 위치의 데이터를 삭제하고, 그 값을 반환, 그 값(삭제한 값)을 반환
		// remove(Object) :	해당 데이터를 삭제하고 결과를 반환 (true or false) 삭제가됏냐 안됏냐
		...
		// contains :  값을 포함하는지 여부 반환(true of false)
		list.add("홍길동");
