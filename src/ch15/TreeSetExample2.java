	...
	public static void main(String[] args) {
		...
		TreeSet<GymMember> gym = new TreeSet<GymMember>(
				...
				public int compare(GymMember o1, GymMember o2) {
					...
					// - o1과 o2의 자리를 유지하고 싶다면 리턴값을 -1로 지정
					// - o1과 o2의 같은 값임을 나타내고 싶다면 0을 리턴값으로 지정
		...
		System.out.println(gym); // [BTS [1005], 김연아 [1001], 박지성 [1000], 봉준호 [1003], 싸이 [1002], 조현아 [1004]]
								// 인코딩 값으로 정렬, 똑같은 성씨인 '박'씨인 박찬호는 중복이라 제거됨
...
class GymMember implements Comparable<GymMember>{
	...
	public int compareTo(GymMember o) {
		...
		// - 현재 인스턴스와 o의 자리를 유지하고 싶으면 -1을 리턴
		// - 현재 인스턴스와 o의 값읕 값임을 나타내려면 0을 리턴
		int next = o.memNum;
