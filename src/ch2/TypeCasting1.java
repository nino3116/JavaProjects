...
//		float f2 = 10.1 // 10.1은 double 데이터 형식의 상수 값 
		...
		// 타입casting을 통해서 값을 억지로 넣을 수 있음.
		// 연산자 :(타입)
		byte c = (byte)b;   // 0000_0000 0000_1010 -> 0000_0000(삭제된다) 0000_1010
		System.out.println(c);
		int i = 10000000;
		byte c1 = (byte)i;
		System.out.println(c1); // 나머지 범위값을 날려리고 byte 최대값만 반환
		
		float f1 = 1.234F;
		int i1 = (int)f1;
		System.out.println(i1); // 소숫점을 날려버리고 정수만 추출
