...
public class StringConversion {
	...
	public static void main(String[] args) {
		...
		System.out.println(str + 100);		// str(문자열) + 100 -> 문자열 더하기는 문자로 덧붙이기가됌
		
		// 숫자 문자열은 short로 변환 - short값의 크기를 벗어나면 안됨.(-32,768 ~ 32,767)
...
//		short valueShort2 = Short.parseShort("60000"); // NumberFormatException: Value out of range. Value:"60000" Radix:10
		...
		String valueConversion = String.valueOf(valueFloat); // 값 변환
