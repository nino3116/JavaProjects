...
public class StringExample1 {
	...
	public static void main(String[] args) {
		...
		// test = hobby; 대입 후에 test == hobby2와 비교했을 동등비교가 가능합니다.
		...
		// 2. 문자열 길이 -> .length() -> 숫자로 길이 알려줌.
		//  문자열에서 문자의 개수를 알고 싶은 경우 사용 :  langth()
		...
		// substring(시작index값) => 해당 인덱스 이후 값을 잘라준다.
		...
		System.out.println(str2.substring(7, 12)); // 끝 인덱스 번호 전까지만 반환 (끝 인덱스제외함)
		...
		// 	repalce(oldStr, newStr)
		//		- oldStr : 바꾸기 위해서 찾는 문자
		//		- newStr : 변경할 문자열
		str ="abcde@naver.com";
		// navar -> microsoft 변경...
...
//			   012345678	index 값	
		...
		String id_1 = "    abc   123 "; // 앞쪽 공백없앰
		String id_2 = " abc   123    "; // 뒤쪽 공백없앰
