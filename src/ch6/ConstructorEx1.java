...
public class ConstructorEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(car1.numOfwhee1);
...
class Car{
	...
	Car() {		// 기본 생성자..(매개값을 받지 않는, instence 생성자)
		// Car()인스턴스 생성시 동작을 구현..
		wheel = "금호";
		numOfwhee1 = 4;
		brand = "KIA";
	...
	// 필드(멤버변수) 초기화 생성자...
	Car(String wheel, int numOfwhee1, String brand, String name){
		// this는 현재 생성된 인스턴스를 의미함.
		
		// this는 언제 사용할까? 클래스의 변수(필드)와 매개변수의 이름이 같은 경우
		// 클래스의 변수를 지칭하기 위해서 this를 사용합니다.
		this.wheel = wheel;
		this.numOfwhee1 = numOfwhee1;
		this.brand = brand;
		this.name  = name;
				
		// 필드 초기화 생성자를 통한 Instence 생성
		...
		System.out.println(car3.numOfwhee1);
	...
	// 메서드(method)
	void go() {
		System.out.println(name +"가 앞으로 이동합니다.");
	}
