...
public class MethodExample1 {
			...
			// 메서드 특징
			//	- 어떤 단어 뒤에 ()가 붙게 됩니다.-> 소괄호가 붙으면 메서드라고 생각하면된다.
			//	- 한번 만들어 두면 여러번 사용이 가능합니다.
			//	- 여러 기능들을 묶어서 이름을 붙여 놓은 것을 의미함...
			//	- 값을 반환 할 수 있다(return)
			
			/*
			 * 	(접근제한자) (static)사용제한자) 반환타입 메서드명(매개변수타입 매개변수며){
			 * 	
			 * 		여러 기능 구현 코드들...
			 * 
			 * 	}
	...
	// 메세지를 전달하면, 해당 메시지 "* * *"값을 양쪽에 붙여주는 문자열을 만드는 메서드...
	//	매개값 전달 : String
	//	반환값 : String
	
	static String makeBanner(String msg) {	// 매개변수 0, 반환값 0
