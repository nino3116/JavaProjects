...
public class ClassExample1 {
	...
	public static void main(String[] args) {
		...
		//	- 클래스의 메서드는 객체의 행동, 클래스의 변수는 객체의 현재 상태는 나타낸다.
		//	- 클래스는 참조형 변수 타입입니다.
		...
		// 	- 다른 패키지에서 import할 때는 pubilc class에만 접근할 수 있음.
		//	- pubilc class는 파일의 이름이기 때문에 그 소스 파일 전체의 주제를 알 수 있은 이름을
		// 	  짓는 것이 좋다.
...
class Student {	// 학생이라는 클래스 선언...
	...
	public int getTotal(){	// 메서드....
		...
		// 메서드 구조...
		// public[접근제한자] int[반환 타입] getTotal[매서드명] ()(매개 변수들...){
		// 		메서드 동작 코드...
