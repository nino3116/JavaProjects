...
public class SingletonExample {
	...
	/*
	 * 싱글톤(Singleton)이란? 클래스의 인스턴스 개수를 제한하는 프로그래밍 방법을 의미함.
...
//		Singleton obj1 = new Singleton();
		...
		Singleton obj1 = Singleton.getInstSingleton();
		Singleton obj2 = Singleton.getInstSingleton();
...
class Singleton{
	...
	// 싱글톤 디자인 생성 단계..
	// 1. 필드 생성
	//  필드는 자유롭게 만들되 객체(자신) 멤버변수를 생성합니다. 접근 제한자는 private
	private String str;
	private int num;
	...
	public static Singleton getInstSingleton() {
		return s;
	}
