...
public class InheritanseEx1 {
	 ...
	 * 	  자식 클래스(child or sub)라고 부르며, 멤버변수와 메서드를 물려준 크랠스를 
	...
	public static void main(String[] args) {
		...
		System.out.println(t1);		// override 안한 결과 : ch7.obj.Teacher@270421f5
	    ...
	    // 재정의한 equals를 통해서 비교		
		System.out.println("s1 과 s3의 비교 결과 : " + s1.equals(s3));
